...
def like_hashtags():
    for tweet in tweepy.Cursor(api.search, q=('#WomenWhoCode OR #100DaysOfCode OR #WomenInTech OR #hackotoberfest2020 -filter:retweets')).items(5):
        try:
            print('\nLike Bot found tweet by @' +
                  tweet.user.screen_name + '. ' + 'Attempting to like.')
